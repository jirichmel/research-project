...
X = np.loadtxt(open(bigram_train_path, "r"), delimiter=",")
X_test = np.loadtxt(open(bigram_test_path, "r"), delimiter=",")
...
parameters1 = [{'kernel': ['rbf'],
               'gamma': [float(10*i) for i in range(11, 21)],
...
with open('KRR_CV_bigram_final_dataset.output', 'w') as f:
